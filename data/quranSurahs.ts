// Surah metadata for the memorization plan calculator: number, name, and
// ayah count in the standard Hafs 'an Asim numbering used in virtually all
// printed Mushafs. Ayah counts are fixed regardless of print edition (unlike
// page/line boundaries, which vary by print), so this is safe to build a
// schedule on without a page-mapping dataset.
...
export const QURAN_SURAHS: QuranSurah[] = [
  ...
  { number: 3, nameAr: "آل عمران", nameEn: "Aal-E-Imran", ayahCount: 200 },
  { number: 4, nameAr: "النساء", nameEn: "An-Nisa", ayahCount: 176 },
  { number: 5, nameAr: "المائدة", nameEn: "Al-Ma'idah", ayahCount: 120 },
  { number: 6, nameAr: "الأنعام", nameEn: "Al-An'am", ayahCount: 165 },
  { number: 7, nameAr: "الأعراف", nameEn: "Al-A'raf", ayahCount: 206 },
  ...
  { number: 13, nameAr: "الرعد", nameEn: "Ar-Ra'd", ayahCount: 43 },
  ...
  { number: 23, nameAr: "المؤمنون", nameEn: "Al-Mu'minun", ayahCount: 118 },
  { number: 24, nameAr: "النور", nameEn: "An-Nur", ayahCount: 64 },
  { number: 25, nameAr: "الفرقان", nameEn: "Al-Furqan", ayahCount: 77 },
  { number: 26, nameAr: "الشعراء", nameEn: "Ash-Shu'ara", ayahCount: 227 },
  ...
  { number: 42, nameAr: "الشورى", nameEn: "Ash-Shuraa", ayahCount: 53 },
  ...
  { number: 56, nameAr: "الواقعة", nameEn: "Al-Waqi'ah", ayahCount: 96 },
  { number: 57, nameAr: "الحديد", nameEn: "Al-Hadid", ayahCount: 29 },
  { number: 58, nameAr: "المجادلة", nameEn: "Al-Mujadila", ayahCount: 22 },
  ...
  { number: 62, nameAr: "الجمعة", nameEn: "Al-Jumu'ah", ayahCount: 11 },
  ...
  { number: 70, nameAr: "المعارج", nameEn: "Al-Ma'arij", ayahCount: 44 },
  ...
  { number: 79, nameAr: "النازعات", nameEn: "An-Nazi'at", ayahCount: 46 },
  ...
  { number: 87, nameAr: "الأعلى", nameEn: "Al-A'la", ayahCount: 19 },
  ...
  { number: 101, nameAr: "القارعة", nameEn: "Al-Qari'ah", ayahCount: 11 },
  ...
  { number: 107, nameAr: "الماعون", nameEn: "Al-Ma'un", ayahCount: 7 },
