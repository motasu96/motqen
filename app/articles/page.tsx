  ...
  return (
    <div className="container-page section">
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((a) => (
          <article key={a.slug} className="card flex flex-col gap-4 p-6">
            <div className="flex aspect-[16/10] items-center justify-center rounded-2xl bg-gold-light">
              <svg viewBox="0 0 80 80" className="h-12 w-12 text-gold-dark" fill="none" stroke="currentColor" strokeWidth="1.6">
