            ...
            {pendingTeachers.length === 0 ? (
              ...
              <ul className="flex flex-col gap-3">
                {pendingTeachers.map((t0) => {
                  ...
                  return (
                    <li key={teacher.id} className="rounded-2xl border border-line bg-bg p-4">
                      <div className="mb-1 flex items-center justify-between gap-3">
                        <span className="text-sm font-extrabold text-ink">{teacher.name}</span>
                        <span className="text-xs text-ink-soft">{teacher.joinDate}</span>
                      </div>
                      <p className="mb-3 text-xs text-ink-soft">{teacher.specialty}</p>
